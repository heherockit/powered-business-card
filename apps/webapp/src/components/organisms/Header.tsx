    ...
    <header className="sticky top-0 z-20 bg-white backdrop-blur border-b border-border text-center">
      ...
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-3 items-center">
        <div className="flex items-center gap-3 justify-self-start">
          ...
          />
          <span className="hidden md:inline font-semibold tracking-wide text-textPrimary">
            {BRAND_NAME}
          </span>
        </div>
        <nav
          aria-label="Main navigation"
          className="hidden md:flex items-center justify-self-center gap-4"
        >
          <a
            href="/"
            className="text-gray-600 px-3 py-2 rounded-md transition hover:text-gray-900 hover:bg-gray-100 focus-ring"
          >
            {t('nav.home')}
          </a>
          <a
        ...
        <div className="flex items-center gap-4 justify-self-end transition-all duration-300">
          ...
          <Button
            ...
            className="inline-flex btn-ghost h-10 transition"
          >
            {/* User icon */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <div className="mx-auto max-w-7xl px-6 py-3 flex flex-col items-center gap-2">
          <a href="/" className="text-gray-700 px-3 py-2 rounded-md hover:bg-gray-100 focus-ring">
            {t('nav.home')}
          </a>
          <a
            href="/templates"
            className="text-gray-700 px-3 py-2 rounded-md hover:bg-gray-100 focus-ring"
          >
            {t('nav.templates')}
          </a>
          <a
